          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#0A4F7E] to-[#0d5a8f] rounded-2xl p-8 text-white">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[#FF7F38] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 text-center">
                <div className="w-16 h-16 bg-[#FF7F38] rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-[#00426D] mb-2">Dammam, KSA</h3>
              ...
              <div className="bg-orange-50 border border-[#FF7F38]/30 rounded-xl p-6">
                <div className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[#FF7F38] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  <div>
                    <h4 className="font-bold text-[#FF7F38] mb-2">Fast Response Promise</h4>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white">
                {/* Form Header */}
                <div className="mb-8">
                  <h2 className="text-3xl md:text-4xl font-bold text-[#00426D] mb-4">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full bg-[#FF7F38] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#d85a28] transition-colors shadow-lg flex items-center justify-center gap-2"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-gradient-to-br from-[#0A4F7E] to-[#0d5a8f] rounded-2xl p-8 text-white relative overflow-hidden">
              ...
              <div className="absolute top-6 right-6">
                <span className="bg-[#FF7F38] text-white px-3 py-1 rounded-full text-xs font-bold">
                  HQ
                </span>
              </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-2xl font-bold text-[#00426D]">Riyadh</h3>
              </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-2xl font-bold text-[#00426D]">Jeddah</h3>
              </div>
