          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <input
                ...
                className="px-4 md:px-6 py-3 rounded-full w-full sm:w-64 md:w-80 text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#F16D34] text-sm md:text-base"
              />
              <button className="bg-[#F16D34] hover:bg-[#d85d2a] px-6 md:px-8 py-3 rounded-full font-semibold transition-colors whitespace-nowrap text-sm md:text-base">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="text-center md:text-left">
            <Link href="/" className="flex items-center gap-3 mb-6 justify-center md:justify-start">
              <div className="bg-[#F16D34] p-2 rounded-lg">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              <a href="#" className="w-10 h-10 bg-white/5 hover:bg-[#F16D34] rounded flex items-center justify-center transition-colors">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="text-gray-400 hover:text-[#F16D34] transition-colors text-sm md:text-base">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/news" className="text-gray-400 hover:text-[#F16D34] transition-colors text-sm md:text-base">
                  News & Insights
                </Link>
              </li>
              <li>
                <Link href="/careers" className="text-gray-400 hover:text-[#F16D34] transition-colors text-sm md:text-base">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 justify-center md:justify-start">
                <svg className="w-5 h-5 text-[#F16D34] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex gap-3 justify-center md:justify-start">
                ...
                <a href="tel:+966138001234" className="text-gray-400 hover:text-[#F16D34] transition-colors text-sm md:text-base">
                  +966 13 800 1234
                </a>
              </li>
              <li className="flex gap-3 justify-center md:justify-start">
                ...
                <a href="mailto:info@metrolink-sa.com" className="text-gray-400 hover:text-[#F16D34] transition-colors text-sm md:text-base">
        ...
        <div className="container mx-auto px-4 py-4 md:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-gray-500">
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
              <Link href="/privacy" className="hover:text-[#F16D34] transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-[#F16D34] transition-colors">
                Terms of Service
              </Link>
              <Link href="/cookies" className="hover:text-[#F16D34] transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
