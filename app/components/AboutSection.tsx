        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              {/* Location Badge */}
              <div className="absolute top-6 left-6 z-10 bg-[#F16D34] text-white px-4 py-3 rounded-xl shadow-lg flex items-center gap-2">
            ...
            {/* Stats Badge - Years */}
            <div className="absolute -bottom-8 -right-4 md:-right-8 bg-[#161E54] text-white px-8 py-6 rounded-2xl shadow-xl z-20">
              <div className="text-5xl md:text-6xl font-bold text-[#F16D34] mb-1">20+</div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-[#161E54]">3</div>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-[#161E54]">200+</div>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-[#161E54]">150+</div>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-3xl font-bold text-[#161E54]">50K</div>
                </div>
