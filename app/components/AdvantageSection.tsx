const advantages = [
  {
    ...
    description: 'Our network includes more than 30 international destination branches, allowing us to provide smooth cargo movement across global markets.',
  },
  {
    id: '24-7-operations',
    icon: (
    ...
    description: 'Our experienced logistics team is committed to providing professional service, timely updates, and reliable cargo handling.',
  },
  {
    id: 'cargo-insurance',
    icon: (
  ...
  },
  {
    ...
    description: 'We provide end-to-end logistics services, from cargo pickup and transportation to customs clearance and final delivery.',
  },
  {
    id: 'fast-clearance',
    icon: (
    ...
    description: 'Our branches in Riyadh, Jeddah, Dammam, and Al Qassim enable us to provide fast and efficient logistics support across the Kingdom.',
  },
  {
    id: '200-experts',
    icon: (
    ...
    description: 'With over 30 years of experience in freight forwarding operations in Saudi Arabia, we understand the logistics industry and the needs of our customers.',
  },
];
